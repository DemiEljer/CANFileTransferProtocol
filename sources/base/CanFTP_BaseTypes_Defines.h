...
typedef uint8_t CanFTP_SendingRepeate_t;
// Тип параметра периодов повторных отправок
typedef uint8_t CanFTP_SendingRepeateInterval_t;
