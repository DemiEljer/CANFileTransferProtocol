...
- Максимальный размер файла - 2^32 * 2048 байт.
...
|RepeateBlockCount|44|6|Количество попыток отправки блоков файла|
|RepeateAckCount|50|6|Количество итераций отправки сообщений подтверждения|
|RepeateInterval|56|8|Интервал времени отправки сообщений подтверждения|
