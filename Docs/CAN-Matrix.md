...
|PartIndex|4|4|Индекс части конфигурации (0)|
|FirstPageIndex|8|10|Индекс страницы записи|
|PagesCount|18|10|Количество задействованных страниц|
|SessionRepeateAckCount|28|8|Количество итераций отправки сообщений подтверждения при управлении сессией|
|SessionRepeateInterval|36|10|Интервал времени отправки сообщений подтверждения при управлении сессией|
|BlockRepeateAckCount|46|8|Количество итераций отправки сообщений подтверждения при отправке блока|
|BlockRepeateInterval|54|10|Интервал времени отправки сообщений подтверждения при отправке блока|

---
### Сообщение SessionConfig2
...
|-------------|-------|------|--------|
|MessageType|0|4|Тип сообщения|
|PartIndex|4|4|Индекс части конфигурации (1)|
|FileLength|8|32|Длина передаваемогого файла|
|SoftwareVersion.Low|40|8|Версия программного обеспечения (младшая часть)|
|SoftwareVersion.Middle|48|8|Версия программного обеспечения (средняя часть)|
|SoftwareVersion.High|56|8|Версия программного обеспечения (старшая часть)|
...
|MessageType|0|4|Тип сообщения|
|Status|4|4|Статус операции|
|PartIndex|8|4|Индекс части конфигурации (0)|

---
### Сообщение Config2Ack
...
|MessageType|0|4|Тип сообщения|
|Status|4|4|Статус операции|
|PartIndex|8|4|Индекс части конфигурации (1)|
|MaxBlockLength|12|12|Максимальная длина блока файла|
